...
module.exports = {
  ...
  transpilePackages: ['@burnt-labs/ui', '@burnt-labs/abstraxion-react', '@burnt-labs/abstraxion-core'],
  webpack: (config) => {
    // Ensure workspace packages are resolved correctly
    config.resolve.alias = {
      ...config.resolve.alias,
      '@burnt-labs/abstraxion-react': path.resolve(__dirname, '../../packages/abstraxion-react'),
