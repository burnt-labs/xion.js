...
export type TransactionSigningSuite =
  | "flow"
  | "gas"
  | "verification"
  | "errors";

export function registerTransactionSigningIntegrationTests(
  selectedSuites: readonly TransactionSigningSuite[],
) {
  ...
  describe("Transaction Signing Integration Tests", () => {
    ...
    describe.runIf(enabledSuites.has("flow"))("Full Transaction Flow", () => {
      it(
    ...
    describe.runIf(enabledSuites.has("gas"))("Gas Estimation", () => {
      it(
    ...
    describe.runIf(enabledSuites.has("verification"))(
