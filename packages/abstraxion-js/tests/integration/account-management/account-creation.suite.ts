...
export type AccountCreationSuite =
  | "secp256k1"
  | "ethwallet"
  | "fee-granting"
  | "errors"
...
export function registerAccountCreationIntegrationTests(
  selectedSuites: readonly AccountCreationSuite[],
) {
  ...
  describe("Account Creation Integration Tests", () => {
    ...
    describe.runIf(enabledSuites.has("secp256k1"))(
      "Secp256K1 Account Creation Flow",
      () => {
        it(
          ...
          async () => {
            ...
            expect(isValidXionAddress(setupResult.smartAccountAddress)).toBe(
              true,
            );
    ...
    describe.runIf(enabledSuites.has("ethwallet"))(
      "EthWallet Account Creation Flow",
      () => {
        it(
          ...
          async () => {
            ...
            expect(connectorResult.authenticator).toMatch(
              /^0x[a-fA-F0-9]{40}$/,
            );
    ...
    describe.runIf(enabledSuites.has("fee-granting"))(
      "Account Creation with Fee Granting",
      () => {
        it(
    ...
    describe.runIf(enabledSuites.has("errors"))(
    ...
    describe.runIf(enabledSuites.has("rediscovery"))(
      "Account Re-discovery After Creation",
      () => {
        it(
