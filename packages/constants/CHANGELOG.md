...
- [#389](https://github.com/burnt-labs/xion.js/pull/389) [`297beee`](https://github.com/burnt-labs/xion.js/commit/297beee2d5b7f17cebb28d8c3ae82bbb090748ff) Thanks [@2xburnt](https://github.com/2xburnt)! - Mainnet dashboard and iframe URLs now resolve to `auth.burnt.com`, replacing `settings.burnt.com`. Testnet dashboard and iframe URLs resolve to `auth.testnet.burnt.com`.
