...
describe("useAbstraxionSigningClient Integration Tests", () => {
  ...
  describe("Hook Returns Signing Client When Connected", () => {
    it("should return undefined client when not connected", async () => {
    ...
    it("should return signing client after successful connection", async () => {
      const config = getTestConfig();
      const signerConfig = {
        chainId: config.chainId,
        rpcUrl: config.rpcUrl,
  ...
  describe("Signing Client Functionality", () => {
    it("should provide signArb function when account is available", async () => {
      const config = getTestConfig();
      const signerConfig = {
        chainId: config.chainId,
        rpcUrl: config.rpcUrl,
    ...
    it("should provide GranteeSignerClient for transaction signing", async () => {
      const config = getTestConfig();
      const signerConfig = {
        chainId: config.chainId,
        rpcUrl: config.rpcUrl,
