...
describe("Session Management - Integration", () => {
  ...
  describe("LocalStorage Persistence", () => {
    it(
      "should persist session data to storage",
      async () => {
        ...
        if (state.status === "connected") {
          ...
          const granterData = await storageStrategy.getItem(
            "abstraxion_granter"
          );
    ...
    it(
      "should store granter address in session",
      async () => {
        const controller = createController();
    ...
    it(
      "should clear sensitive data on disconnect",
      async () => {
        const controller = createController();
        ...
        const sessionData = await storageStrategy.getItem(
          "abstraxion_session"
        );
  ...
  describe("Session Restoration", () => {
    it(
      "should restore session from persisted data",
      async () => {
  ...
  describe("Multi-Tab Synchronization", () => {
    it(
      "should react to storage changes (simulated multi-tab)",
      async () => {
        const controller = createController();
        await controller.initialize();
    ...
    it(
      "should sync logout across tabs (simulated)",
      async () => {
        const controller = createController();
        await controller.initialize();
        await controller.connect();
  ...
  describe("Session Security", () => {
    it(
      "should clear all data on logout",
      async () => {
        const controller = createController();
        await controller.initialize();
        await controller.connect();
        ...
        // Verify data exists
        const beforeLogout = await storageStrategy.getItem(
          "abstraxion_granter"
        );
        ...
        const afterLogout = await storageStrategy.getItem(
          "abstraxion_granter"
        );
    ...
    it(
      "should not expose sensitive data in state",
      async () => {
        const controller = createController();
        await controller.initialize();
        await controller.connect();
  ...
  describe("Error Recovery", () => {
    it(
      "should recover from storage errors",
      async () => {
  ...
  describe("Session Expiration Detection", () => {
    it(
      "should detect when session data is stale",
      async () => {
        const controller = createController();
  ...
  describe("Grant Validation in Session", () => {
    it(
      "should validate grants exist in persisted session",
      async () => {
        const controller = createController();
    ...
    it(
      "should detect missing grants in restored session",
      async () => {
  ...
  describe("Session Data Encryption", () => {
    ...
    it(
      "should validate stored data structure",
      async () => {
        const controller = createController();
  ...
  describe("Multi-Tab Cross-Window Scenarios", () => {
    it(
      "should handle simultaneous initialization in multiple tabs",
      async () => {
    ...
    it(
      "should propagate storage changes across tabs",
      async () => {
        const controller1 = createController();
        const controller2 = createController();
  ...
  describe("Session Lifecycle Management", () => {
    ...
    it(
      "should clean up all resources on disconnect",
      async () => {
        const controller = createController();
