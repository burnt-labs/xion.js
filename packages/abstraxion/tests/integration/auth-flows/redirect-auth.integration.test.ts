...
describe("Redirect Authentication Flow - Integration", () => {
  ...
  describe("Initial Login Flow", () => {
    it(
      "should initialize RedirectController with config",
      async () => {
    ...
    it(
      "should generate redirect URL and initiate redirect on connect",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
    ...
    it(
      "should use treasury address in redirect URL when configured",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
  ...
  describe("State Management", () => {
    it(
      "should transition through states during connection",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
  ...
  describe("Session Restoration", () => {
    it(
      "should attempt to restore session on initialization",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
    ...
    it(
      "should clear storage on disconnect",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
  ...
  describe("Grant Configuration", () => {
    it(
      "should include bank spend limits when configured",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
    ...
    it(
      "should include staking permissions when enabled",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
    ...
    it(
      "should include contract grants when configured",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
  ...
  describe("Error Handling", () => {
    it(
      "should handle invalid RPC URL gracefully",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
  ...
  describe("Redirect URL Validation", () => {
    it(
      "should include all required parameters in redirect URL",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
    ...
    it(
      "should encode special characters in callback URL",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
    ...
    it(
      "should fetch dashboard URL from RPC when not provided",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
  ...
  describe("Callback Handling Simulation", () => {
    it(
      "should handle callback with success code",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
    ...
    it(
      "should handle callback with error/cancellation",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
  ...
  describe("Grant Validation Flow", () => {
    it(
      "should validate grant configuration matches request",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
    ...
    it(
      "should validate treasury configuration in grants",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
  ...
  describe("Multiple Permission Types", () => {
    it(
      "should handle all permission types together",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
    ...
    it(
      "should handle permission combinations without errors",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
  ...
  describe("URL Cleanup After Callback", () => {
    it(
      "should prepare for URL cleanup after redirect",
      async () => {
        const storageStrategy = createMockStorageStrategy();
        const redirectStrategy = createMockRedirectStrategy();
