/**
 * Mock treasury data for testing
 * Provides realistic treasury contract responses and grant configurations
 */

/**
 * Mock treasury parameters
 */
...
/**
 * Mock grant type URLs (message types for authz/feegrant)
 */
...
/**
 * Mock grant configurations
 */
export const mockGrantConfigs = {
  /**
   * Generic authorization for execute messages
   */
  genericExecute: {
    authorization: {
...
/**
 * Mock treasury configurations (complete)
 */
export const mockTreasuryConfigs = {
  /**
   * Basic treasury with minimal grants
   */
  basic: {
...
/**
 * Mock treasury contract responses
 */
 ...
 * DAO DAO treasuries have a different format
 */
export const mockDaoTreasuryResponses = {
  /**
   * DAO DAO specific treasury configuration
   */
  basic: {
    config: {
...
/**
 * Known treasury addresses for integration tests
 */
export const testTreasuryAddresses = {
  /**
   * Test treasury on xion-testnet-2
   */
  testnet: "xion1sv6kdau6mvjlzkthdhpcl53e8zmhaltmgzz9jhxgkxhmpymla9gqrh0knw",

  /**
   * Mock addresses for unit tests
   */
  mock: {
    basic: "xion1treasury1address",
    full: "xion1treasury2address",
    daoDao: "xion1daotreasury1address",
  },
};
