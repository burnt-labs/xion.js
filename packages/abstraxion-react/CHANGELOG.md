...
- [#369](https://github.com/burnt-labs/xion.js/pull/369) [`4b655df`](https://github.com/burnt-labs/xion.js/commit/4b655df245495ad4d946ee3b5d874361cb97425d) Thanks [@ertemann](https://github.com/ertemann)! - refactor(abstraxion-react): rename from `@burnt-labs/abstraxion`. The React package keeps the JSX/provider/hooks surface; framework-agnostic controllers, strategies, and signing logic move out to the new `@burnt-labs/abstraxion-js` package.

- [#371](https://github.com/burnt-labs/xion.js/pull/371) [`fc68aa7`](https://github.com/burnt-labs/xion.js/commit/fc68aa7c3872ce7121e84298ecc7b9362b359131) Thanks [@ertemann](https://github.com/ertemann)! - `@burnt-labs/ui` is deprecated and not supported in v1.0.0. Its source has been removed from the active workspace; the last published version is `@burnt-labs/ui@1.0.0-alpha.26`. The legacy `<Abstraxion>` modal it powered is fully superseded by the iframe embed in `@burnt-labs/abstraxion-react` (`AbstraxionEmbed` + `AbstraxionProvider`). Consumers should migrate off `@burnt-labs/ui` and use the dashboard iframe embed or app-local UI primitives instead.
...
- Updated dependencies [[`6b6a907`](https://github.com/burnt-labs/xion.js/commit/6b6a907230b6c56d151e88a6b7371e13379bd19a)]:
  ...
  - @burnt-labs/account-management@1.0.0-alpha.11
...
- Updated dependencies [[`847ad14`](https://github.com/burnt-labs/xion.js/commit/847ad14b0d6c75f9f3272723176638ac246c4597)]:
  ...
  - @burnt-labs/account-management@1.0.0-alpha.7
...
- Updated dependencies [[`00fb815`](https://github.com/burnt-labs/xion.js/commit/00fb815df96b5707714dfd4bfe9f39d636c8b5b1)]:
  ...
  - @burnt-labs/account-management@1.0.0-alpha.5
...
- Updated dependencies [[`4b572f0`](https://github.com/burnt-labs/xion.js/commit/4b572f0937ce567ea40868b6b63987d933f6ca9a)]:
  ...
  - @burnt-labs/account-management@1.0.0-alpha.4
...
- Updated dependencies [[`45e3a7b`](https://github.com/burnt-labs/xion.js/commit/45e3a7b6cb83b5fb812a382e09073285f32303d5)]:
  - @burnt-labs/account-management@1.0.0-alpha.3
...
- Updated dependencies [[`f7359df`](https://github.com/burnt-labs/xion.js/commit/f7359dfdb0d3de55f51b7d8abcfa2e3c7baeb8e9)]:
  - @burnt-labs/account-management@1.0.0-alpha.2
...
- [#292](https://github.com/burnt-labs/xion.js/pull/292) [`9a6b001`](https://github.com/burnt-labs/xion.js/commit/9a6b001d8ee5e65ecfc18587bd0706e7c9d2eb5e) Thanks [@justinbarry](https://github.com/justinbarry)! - Replace demo link with a link to the quickstart app
